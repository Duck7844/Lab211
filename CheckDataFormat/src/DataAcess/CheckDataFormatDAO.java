...
public class CheckDataFormatDAO {
    private static CheckDataFormatDAO instance = null;
    Library l;
    ...
    public static CheckDataFormatDAO Instance() {
        if (instance == null) {
            synchronized (CheckDataFormatDAO.class) {
                if (instance == null) {
                    instance = new CheckDataFormatDAO();
                }
            }
        }
        return instance;
